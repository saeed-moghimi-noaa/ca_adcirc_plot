...
#### INPUTS ####
base_dir_sm         = '/scratch2/COASTAL/coastal/save/NAMED_STORMS/HARVEY_ADCIRC/ecgc2021'
track_fname         = '/scratch2/COASTAL/coastal/noscrub/Yuji.Funakoshi/nsem-workflow/parm/storms/harvey/bal092017.dat'
hwm_fname           = '/scratch2/COASTAL/coastal/noscrub/Yuji.Funakoshi/nsem-workflow/parm/storms/obs/hwm/harvey2017.csv'
...
if False:
    ...
    cases[key]['dir']    = base_dir_sm + '/harvey.tide_baserun/'
...
if True:
    ...
    cases[key]['dir']    = base_dir_sm + '/harvey.best_track2ocn/'
    #cases[key]['label']  = 'No Offset'
    cases[key]['label']  = 'No NWM input'
    cases[key]['hsig_file'] = None
    cases[key]['wdir_file'] = None
    key0 = key
...
if True:
    ...
    cases[key]['dir']    = base_dir_sm + '/harvey.nwm4best_track2ocn/'
    #cases[key]['label']  = 'Offset'
    cases[key]['label']  = 'NWM input'
    cases[key]['hsig_file'] = None
    cases[key]['wdir_file'] = None
    key1 = key
