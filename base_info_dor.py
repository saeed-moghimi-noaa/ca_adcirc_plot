...
base_dir_sm   = '/scratch2/COASTAL/coastal/noscrub/Saeed.Moghimi/01_stmp_ca/stmp21_dorian/'
...
if True:
    ...
    cases[key]['dir']    = base_dir_sm + '/a10_DOR_OCN_SPINUP_v1.0/rt_20200923_h18_m27_s39r236/' 
...
if True:
    ...
    cases[key]['dir']    = base_dir_sm + 'a70_DOR_ATM_WAV2OCN_v1.0/rt_20200924_h15_m43_s31r313/'      
    cases[key]['label']  = 'ATM&WAV'    
    cases[key]['hsig_file'] = '/scratch2/COASTAL/coastal/save/Saeed.Moghimi/models/NEMS/NEMS_inps/nsemodel_inps/hsofs_forcings/dor_v0/inp_ww3/ww3.HSOFS.2019_hs.nc'
    cases[key]['wdir_file'] = '/scratch2/COASTAL/coastal/save/Saeed.Moghimi/models/NEMS/NEMS_inps/nsemodel_inps/hsofs_forcings/dor_v0/inp_ww3/ww3.HSOFS.2019_dir.nc'
    key1 = key 
